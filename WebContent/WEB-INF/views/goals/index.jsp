...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
            ...
            <tbody>
                ...
                <c:forEach var="goal" items="${goals}" varStatus="status">
                    <tr class="row${status.count %2 }">
                        ...
                        <td class="created_date"><fmt:formatDate
                                value="${goal.created_at }" /></td>
                        <td class="updated_at"><fmt:formatDate
                                value="${goal.updated_at }" /></td>
                    </tr>
        ...
        <p>
            <a href="<c:url value='/goals/new' />">新規の登録</a>
        </p>
    </c:param>
</c:import>