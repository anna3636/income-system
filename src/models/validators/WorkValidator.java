...
public class WorkValidator {
    public static List<String> validate(Work w, Boolean name_duplicate_check_flag, Boolean password_check_flag) {
        ...
        /* String income_error=_validateIncome(w.getIncome());
        if(!income_error.equals("")){
            errors.add(income_error);
        }*/
        return errors;
    }
    ...
    /* private static String _validateIncome(Integer income){
       String money=String.valueOf(income);
